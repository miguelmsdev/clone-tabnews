function Home() {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', padding: '20px', alignItems: 'center', background: "#730045", borderRadius: '40px' }}>
        <div style={{ padding: '10px 1px'}}> {/* Padding around the image */}
          <img
            src="/images/20230729_160754.jpg" // Replace with your image URL
            alt="Two Lovers"
            style={{ display: 'block', margin: 'auto', width: '50%', height: 'auto', borderRadius: '10px' }}
          />
        </div>
        <div style={{ padding: '10px 1px' }}> {/* Padding around the text */}
          <h1 style={{ color: "#ffffff", fontSize: '19px', fontFamily: 'Pacifico',textShadow: '2px 2px 4px rgba(0, 0, 0, 0.5)' }}> {/* Font size set here */}
            ...
            <br /> {/* Line break here */}
            <br /> {/* Line break here */}
            Thank you, with all we've been through I wouldn't dare to say God didn't have our back during the entire time, and I'm sure that as long as we respect ourselves, Him, and others, we're still gonna be blessed with health, wisdom, and happiness by him.
            <br /> {/* Line break here */}
            <br /> {/* Line break here */}
            Let's be strong and always help each other in their journey, because we're two separate beings that together form one completely new one, with a new journey.
            <br /> {/* Line break here */}
            <br /> {/* Line break here */}
